...
public class Configs {
    ...
    public void loadAll() {
        ...
        this.chat = new ChatConfig(config);
    ...
    public static class NametagConfig {
        ...
        public NametagConfig(FileConfiguration config) {
            ...
            this.name = config.getString("modules.nametags.format.name", "%player_name%");
    ...
    public static class MessagesConfig {
        ...
        public MessagesConfig(FileConfiguration config) {
            ...
            this.moduleToggled = config.getString("messages.module_toggled", "&aModule &e%module% &a%state%");
