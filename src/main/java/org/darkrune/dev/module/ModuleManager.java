 ...
 * Регистрирует, инициализирует и управляет модулями.
 *
 * @author DarkRune Dev
 * @since 1.0.0
 */
public class ModuleManager {
    ...
    /**
     * Инициализация и регистрация всех модулей.
     */
    ...
    /**
     * Корректное отключение всех модулей.
     */
    ...
    /**
     * Переключить состояние модуля по имени.
     *
     * @return true, если модуль найден и переключён
     */
    ...
    /**
     * Получить список отключённых модулей.
     */
    ...
    /**
     * Получить имена активных модулей через запятую (для отладки).
     */
